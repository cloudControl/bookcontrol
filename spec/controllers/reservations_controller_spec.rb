...
describe ReservationsController do
  ...
  let(:valid_attributes) { { "begin_date" => "2013-07-01 15:09:42" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved reservation as @reservation" do
        ...
        post :create, {:reservation => { "begin_date" => "invalid value" }}, valid_session
        assigns(:reservation).should be_a_new(Reservation)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested reservation" do
        ...
        Reservation.any_instance.should_receive(:update_attributes).with({ "begin_date" => "2013-07-01 15:09:42" })
        put :update, {:id => reservation.to_param, :reservation => { "begin_date" => "2013-07-01 15:09:42" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the reservation as @reservation" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Reservation.any_instance.stub(:save).and_return(false)
        put :update, {:id => reservation.to_param, :reservation => { "begin_date" => "invalid value" }}, valid_session
        assigns(:reservation).should eq(reservation)
      end
